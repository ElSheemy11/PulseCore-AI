...
import { AppleIcon, Calendar, DumbbellIcon } from 'lucide-react'
...
const ProfilePage = () => {
  ...
  const allPlans = useQuery(api.plans.getPlans, {userId})
              ...
              <Tabs defaultValue='workout' className='w-full'>
                  ...
                  <div className="space-y-4">
                    ...
                    <Accordion type='single' className='space-y-4'>
                      {currentPlan.workoutPlan.exercises.map((exerciseDay, idx) => (
                        <AccordionItem key={idx} value={exerciseDay.day}
                ...
                <TabsContent value='diet'>
                  <div className="space-y-4">
                    ...
                    <div className="space-y-4">
                      {currentPlan.dietPlan.meals.map((meal, idx) => (
                        <div
                          key={idx}
